...
<body class="bg-upknavy text-white font-body antialiased overflow-x-hidden" x-data="{ mobileMenu: false }">
    ...
    <a href="https://wa.me/6281234567890?text=Hello%20UPK%20Seaweed%2C%20I%20would%20like%20to%20inquire%20about%20your%20products."
       target="_blank"
       rel="noopener noreferrer"
       id="whatsapp-cta"
       class="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25D366] hover:bg-[#20BD5A] text-white px-5 py-3.5 rounded-full shadow-2xl hover:shadow-[0_0_30px_rgba(37,211,102,0.4)] transition-all duration-300 group hover:scale-105"
