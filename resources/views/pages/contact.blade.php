...
@section('content')
<section class="relative pt-48 pb-24 bg-upknavy overflow-hidden">
    {{-- Hero Background --}}
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-7 reveal">
                <div class="glass p-8 sm:p-12 rounded-[3.5rem] border border-white/5 shadow-2xl relative overflow-hidden group">
                    ...
                    <h3 class="text-2xl font-heading font-black text-white uppercase tracking-tighter mb-10">
                    ...
                    <form action="#" class="space-y-8">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            <div class="space-y-3">
                                <label class="block text-[10px] font-black text-gray-500 uppercase tracking-widest px-1">{{ __('messages.contact_name') }}</label>
                                <input type="text" placeholder="John Doe" class="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-upkgreen/50 transition-all placeholder:text-gray-700">
                            </div>
                            <div class="space-y-3">
                                <label class="block text-[10px] font-black text-gray-500 uppercase tracking-widest px-1">{{ __('messages.contact_email') }}</label>
                                <input type="email" placeholder="john@company.com" class="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-upkgreen/50 transition-all placeholder:text-gray-700">
                            </div>
                        </div>

                        <div class="space-y-3">
                            <label class="block text-[10px] font-black text-gray-500 uppercase tracking-widest px-1">{{ __('messages.contact_subject') }}</label>
                            <input type="text" placeholder="{{ __('messages.contact_subject') }}..." class="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-upkgreen/50 transition-all placeholder:text-gray-700">
                        </div>

                        <div class="space-y-3">
                            <label class="block text-[10px] font-black text-gray-500 uppercase tracking-widest px-1">{{ __('messages.contact_message') }}</label>
                            <textarea rows="5" placeholder="{{ __('messages.contact_message') }}..." class="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-upkgreen/50 transition-all resize-none placeholder:text-gray-700"></textarea>
                        </div>
            ...
            <div class="lg:col-span-5 space-y-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
                    {{-- Email --}}
                    <div class="glass p-8 rounded-[2.5rem] border border-white/5 group hover:border-upkgreen/30 transition-all">
                        ...
                        <h4 class="text-white font-black text-xs uppercase tracking-widest mb-2">{{ __('messages.contact_sales_title') }}</h4>
                        <p class="text-gray-500 text-[10px] uppercase font-bold tracking-widest mb-4">{{ __('messages.contact_sales_desc') }}</p>
                    ...
                    <div class="glass p-8 rounded-[2.5rem] border border-white/5 group hover:border-upkgreen/30 transition-all">
                        ...
                        <h4 class="text-white font-black text-xs uppercase tracking-widest mb-2">{{ __('messages.contact_support_title') }}</h4>
                        <p class="text-gray-500 text-[10px] uppercase font-bold tracking-widest mb-4">{{ __('messages.contact_support_desc') }}</p>
                ...
                {{-- Map Card --}}
                <div class="glass p-8 rounded-[3rem] border border-white/5 group overflow-hidden">
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <h4 class="text-white font-black text-xs uppercase tracking-widest">{{ __('messages.contact_hq_title') }}</h4>
                    </div>
                    
                    <p class="text-gray-500 text-xs font-bold uppercase tracking-widest leading-relaxed mb-8">
