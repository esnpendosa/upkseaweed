...
<div class="relative pt-48 pb-24 bg-upknavy overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16 reveal">
            <div>
                <h1 class="text-5xl lg:text-8xl font-heading font-black text-white mb-6 uppercase tracking-tighter leading-none">
                    {!! __('messages.prod_h1') !!}
                </h1>
                <p class="text-gray-400 text-xl font-medium max-w-2xl leading-relaxed">{{ __('messages.prod_subtitle') }}</p>
            </div>
            <div class="flex items-center gap-4">
                 <div class="glass p-2 rounded-3xl border border-white/5 flex shadow-2xl">
                    ...
                    <button class="px-10 py-5 text-gray-500 hover:text-white rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all hover:bg-white/5">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div class="lg:col-span-1 space-y-10 reveal">
                <div class="glass p-8 rounded-[2.5rem] border border-white/5">
                    <h3 class="text-white text-[10px] font-black uppercase tracking-[.4em] mb-8 decoration-upkgreen underline underline-offset-8 decoration-2">
                    ...
                    <div class="space-y-4">
                        ...
                        <label class="flex items-center gap-4 cursor-pointer group">
                            <div class="relative w-5 h-5">
                                ...
                                <div class="w-full h-full rounded border-2 border-white/10 bg-white/5 peer-checked:bg-upkgreen peer-checked:border-upkgreen transition-all"></div>
                            </div>
                            <span class="text-sm font-bold text-gray-400 group-hover:text-white transition-colors">{{ $cat }}</span>
                        </label>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="glass p-8 rounded-[2.5rem] border border-white/5">
                    <h3 class="text-white text-[10px] font-black uppercase tracking-[.4em] mb-8 decoration-blue-500 underline underline-offset-8 decoration-2">{{ __('messages.prod_cert_title') }}</h3>
                    <div class="space-y-6">
                        <div class="flex items-center gap-4 text-gray-400 text-xs font-bold leading-relaxed">
                ...
                <div class="p-10 glass rounded-[3rem] bg-gradient-to-br from-upkgreen/10 to-transparent border border-upkgreen/20 shadow-2xl">
                    <h4 class="text-white text-xl font-heading font-black mb-4">{{ __('messages.prod_custom_title') }}</h4>
                    <p class="text-gray-400 text-xs mb-8 leading-loose font-medium">{{ __('messages.prod_custom_sub') }}</p>
                    <a href="https://wa.me/{{ \App\Models\Setting::get('whatsapp_number') }}" class="inline-block text-[10px] font-black uppercase text-upkgreen tracking-[0.3em] border-b-2 border-upkgreen pb-1 hover:text-white hover:border-white transition-all">
            ...
            <div class="lg:col-span-3">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                    ...
                    <div class="reveal glass rounded-[3rem] border border-white/5 overflow-hidden flex flex-col group transition-all duration-500 hover:border-upkgreen/30 hover:-translate-y-2 shadow-2xl">
                        {{-- Image Area --}}
                        <div class="aspect-square relative overflow-hidden bg-upknavy-700">
                            ...
                            @else
                                <div class="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-upknavy-700 to-upknavy-900 border-2 border-white/5 relative overflow-hidden">
                                     ...
                                     <span class="z-10 text-[8px] font-black uppercase tracking-[0.4em] text-gray-700 group-hover:text-upkgreen transition-colors">UPK SEAWEED HUB</span>
                                </div>
                            @endif
                        ...
                        <div class="p-10 flex-1 flex flex-col">
                            <h3 class="text-2xl font-heading font-extrabold text-white mb-4 leading-tight group-hover:text-upkgreen transition-colors">{{ $product->getLocalized('title') }}</h3>
                            <p class="text-gray-500 text-sm font-medium line-clamp-3 leading-loose mb-10 flex-1">
                            ...
                            <div class="flex items-center justify-between pt-8 border-t border-white/5">
                                <div class="flex flex-col">
                                    <span class="text-[8px] font-black text-gray-600 uppercase tracking-[0.3em] mb-2">{{ __('messages.prod_price_from') }}</span>
                                ...
                                <a href="https://wa.me/{{ \App\Models\Setting::get('whatsapp_number') }}?text=Inquiry%20{{ urlencode($product->getLocalized('title')) }}" 
                                   target="_blank"
                                   class="w-14 h-14 rounded-2xl glass border border-white/10 flex items-center justify-center text-white hover:bg-upkgreen hover:border-upkgreen transition-all shadow-2xl active:scale-95 group/btn">
