...
<div class="relative pt-48 pb-24 bg-upknavy overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-gray-400 text-xl leading-relaxed font-medium">
                ...
                <div class="absolute -bottom-10 -left-10 glass p-8 rounded-3xl border border-white/10 hidden sm:block animate-bounce-slow">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-white font-black text-xs uppercase tracking-widest">Global Standards</p>
                            <p class="text-gray-500 text-[10px] uppercase font-bold tracking-widest">FAO/HACCP Certified</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 reveal">
            ...
            <div class="group relative glass rounded-[2.5rem] p-10 border border-white/5 hover:border-purple-500/30 transition-all duration-500 flex flex-col h-full">
                ...
                <div class="mb-10">
                    <span class="text-[10px] font-black uppercase tracking-[0.3em] text-purple-500/60 block mb-4">{{ __('messages.edu_module_badge') }}</span>
                    <h3 class="text-2xl font-heading font-black text-white leading-tight uppercase tracking-tight group-hover:text-purple-400 transition-colors">{{ $module->getLocalized('title') }}</h3>
                </div>
                
                <p class="text-gray-500 text-sm leading-relaxed mb-12 line-clamp-4 font-medium italic">
                    {{ $module->getLocalized('description') }}
                </p>

                <div class="mt-auto">
                    <a href="{{ $module->link ?? '#' }}" class="inline-flex items-center gap-3 text-white text-[10px] font-black uppercase tracking-[0.2em] bg-purple-500/20 px-8 py-4 rounded-2xl hover:bg-purple-500 transition-all duration-300 shadow-lg group/btn">
            ...
            @empty
            <div class="col-span-full py-24 text-center glass rounded-[3rem] border-dashed border-2 border-white/10">
                <p class="text-gray-500 font-black uppercase tracking-widest italic opacity-50">{{ __('messages.edu_empty') }}</p>
            </div>
            @endforelse
        </div>
        ...
        <div class="mt-32 reveal">
            <div class="glass rounded-[4rem] p-12 sm:p-20 text-center relative overflow-hidden border border-white/5 bg-gradient-to-br from-purple-500/5 via-transparent to-upkgreen/5">
                ...
                <div class="relative z-10 max-w-2xl mx-auto">
                    <h2 class="text-4xl lg:text-5xl font-heading font-black text-white mb-6 uppercase tracking-tighter leading-tight">
